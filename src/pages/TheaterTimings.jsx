...
<div>
<p className="font-semibold">{theatres.name}</p>
...
{
    theatres.timings.map((slot, i) => (
<button key={i} className="border cursor-pointer hover:bg-gray-100
 border-gray-300 rounded-[16px] px-12 
 py-2 text-sm flex flex-col items-center justify-center">
<span className='leading-tight fonr-semibold'>
{slot.time}
</span>
