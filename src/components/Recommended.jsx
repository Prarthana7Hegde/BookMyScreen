...
const Recommended = () => {
return (
<div className='w-full py-6bg-white'>
...
<div key={i} className='rounded overflow-hidden cursar-pointer'>
...
<div
className="bg-black text-white text-sm px-2 py-1 flex items-center justify-between "
>
