...
<span key={1} className='bg-white border border-gray-200
text-[#f74362] py-1 px-3 rounded-[24px] text-smcursor-pointer
hover:bg-gray-100'>
{lang}
</span>
))
...
Explore Upcoming Movies <span className='ml-1'>→</span> </a>
</div>
